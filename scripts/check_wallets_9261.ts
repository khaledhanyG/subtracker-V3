...
const check = async () => {
    ...
    try {
        const idToCheck = 'cea05e1d-6207-4611-8676-13454b2eb750';
        ...
        // Also check if wallet 'noura virt-9261' exists to compare
        const res2 = await client.query(`SELECT id, name FROM wallets WHERE name ILIKE '%9261%'`);
        console.log("Searching by name '%9261%':");
