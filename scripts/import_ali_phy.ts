...
const importAliPhy = async () => {
    ...
    try {
        ...
        const csvPath = path.resolve('bulkUpdate/trans-ali-phy.csv');
        ...
        console.log(`Ali Phy Import finished. Success: ${successCount}, Failed: ${failCount}`);
        client.release();
    } catch (e) {
