...
const check = async () => {
    ...
    try {
        const idToCheck = 'cea05e1d-6207-4611-8676-13454b2eb752';
        ...
        // Also check if wallet 'reema virt-1235' exists to compare
        const res2 = await client.query(`SELECT id, name FROM wallets WHERE name ILIKE '%1235%'`);
        console.log("Searching by name '%1235%':");
